@extends('layouts.master'); @section('title') Participant List @endsection @section('content')
<div class="row">
                            ...
                            <?php $index = 1; ?>
                                ...
                                <ul>
                                    ...
                                    <form action="{{route('TrainingView')}}" method="POST">
                                      {{ csrf_field() }}
                                    <br>
                                    <input type="hidden" name="id" value="{{$enrol->training->id}}">
                                    <li>
                                       <button  type="submit" class="">{{$enrol->training->title}} </button>
                                    </li>
                                    </form>
                                    @endforeach
                                </ul>
                                    ...
                                    <td width="100px"> {{ $list->landline }}</td>
                                    <td width="100px"> {{ $list->cell_number }}</td>
                                    <td width="100px"> {{ $list->gender }}</td>
